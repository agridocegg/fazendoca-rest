...
export class ItemControllerBase {
  ...
  async findManyInventoryItem(
    ...
    const results = await this.service.findInventoryItem(params.id, {
      ...query,
      select: {
        createdAt: true,
  ...
  @common.Delete("/:id/inventoryItem")
  @nestAccessControl.UseRoles({
    resource: "Item",
    action: "update",
    possession: "any",
